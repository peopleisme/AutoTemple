<?php
  ...
  <div class="logowanie_container">
    ...
    <ul class="RegisterErrorTooltip">
      ...
      <div class="password">
        <span>Hasło</span>
        <input class="input_password" type="password" name="input_password" value="" placeholder="hasło"
        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,31}" title="Hasło musi zawierać conajmniej jedną wielką literę, jedną małą literę oraz jedną cyfrę, i mieć od 6 do 32 znaków" required>    
      </div>
      <div class="password_check">
        <span>Powtórz hasło</span>
        <input class="input_password" type="password" name="input_password_check" value="" placeholder="hasło"
        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,31}" title="Hasło musi zawierać conajmniej jedną wielką literę, jedną małą literę oraz jedną cyfrę, i mieć od 6 do 32 znaków " required >
      </div>
